...
tokenizer = AutoTokenizer.from_pretrained('./bert-base-greek-uncased-v1') # initialize tokenizer

data_collator = DataCollatorForLanguageModeling(
    tokenizer=tokenizer, mlm=True, mlm_probability=0.15 # initialize data collector
)
...
for s in eval_samples['input_ids']: 
  encoding = {'input_ids': s}   
...
model = AutoModelForMaskedLM.from_pretrained('./bert-base-greek-uncased-v1')
